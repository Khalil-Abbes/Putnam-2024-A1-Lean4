[README.md](https://github.com/user-attachments/files/26964560/README.md)
**Project Name**
...
Max Mustermann, 4071234  
Bertram Beispiel, 4071235  

Documentation files should be in the Docs/ folder, the project code should be in /fmil26project
At the top of each code file there needs to be a comment on who the author of the file is (if you worked on it together, put all authors).  
